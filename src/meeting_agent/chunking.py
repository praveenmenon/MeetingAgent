...
class TranscriptChunker:
    ...
    def chunk_by_speakers(self, transcript: str) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            ...
            if (current_size + line_size > self.max_chunk_size and 
                current_chunk and is_speaker_change):
    ...
    def chunk_by_time_segments(self, transcript: str, segment_minutes: int = 15) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            ...
            if timestamp:
                ...
                if self._time_diff_minutes(current_start_time, timestamp) >= segment_minutes:
                    if current_chunk:
                        chunk_text = '\n'.join(current_chunk)
                        chunks.append({
                            'id': chunk_id,
    ...
    def should_chunk(self, transcript: str) -> bool:
        ...
        return (
            transcript_size > self.max_chunk_size * 2 or  # Large transcript
            speaker_count > 10 or  # Many speakers
            line_count > 200  # Long transcript
        )
    ...
    def _is_speaker_line(self, line: str) -> bool:
        ...
        return (
            bool(re.search(timestamp_pattern, line)) or
            bool(re.match(speaker_pattern, line)) or
            line.endswith(':')
        )
