...
class ModelParams:
    ...
    def to_anthropic_dict(self, base_model: str = "claude-3-5-sonnet-20240620") -> Dict[str, Any]:
...
class AIConfig:
    ...
    def get_params(self, task_type: TaskType) -> ModelParams:
        ...
        return self.task_configs.get(task_type, self.task_configs[TaskType.SUMMARIZATION])
    
    def get_openai_params(self, task_type: TaskType, base_model: str = "gpt-4o-mini") -> Dict[str, Any]:
        """Get OpenAI API parameters for a task"""
        params = self.get_params(task_type)
        return params.to_openai_dict(base_model)
    
    def get_anthropic_params(self, task_type: TaskType, base_model: str = "claude-3-5-sonnet-20240620") -> Dict[str, Any]:
